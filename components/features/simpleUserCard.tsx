...
export const SimpleUserCard: React.FC<SimpleUserCardProps> = (props) => {
    ...
    return <div className='border border-black rounded overflow-hidden sm:min-w-64 shadow-lg'>
        {props.imageSrc
        ...
        <p className='px-2 flex sm:gap-5 flex-wrap justify-between items-center border-t border-black'>
